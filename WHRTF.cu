...
// convolution
extern "C" float* convHost1(float* Gl_old, int filtroLength, float* sparsArray, int sparsLength);
extern "C" float* convSimple(float* signal, int signalLength, float* filter, int filterLength);
