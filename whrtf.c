...
float* getRespImp(int numFiltros, float** G, int* G_size, int* resultLength);
...
extern float* resp_imp(char* filtros[], int numFiltros, float** G, int* G_size, int* resultLength);
